...
{{-- Hero --}}
<section class="bg-gradient-to-br from-black via-slate-950 to-blue-950 py-24 relative overflow-hidden border-b border-slate-800">
    ...
    <div class="max-w-5xl mx-auto px-4 text-center relative z-10">
        ...
        <h1 class="font-display font-black text-5xl md:text-7xl mb-6 tracking-tight">
            About Zinlink Tech
        </h1>
    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <div class="mt-10 flex flex-wrap gap-4">
                    ...
                    <a href="{{ route('products') }}"
                       class="bg-blue-600 hover:bg-blue-700 text-white px-7 py-3 rounded-2xl font-bold text-sm transition shadow-lg shadow-blue-900/40">
                        Browse Products
                    </a>

                    <a href="{{ route('contact') }}"
                       class="border border-slate-700 hover:border-blue-500 hover:text-blue-400 text-slate-300 px-7 py-3 rounded-2xl font-bold text-sm transition">
                        Contact Us
                    </a>
            ...
            <div class="grid grid-cols-2 gap-5">
                ...
                <div class="bg-slate-900 border border-slate-800 rounded-3xl p-8 text-center hover:border-blue-500/40 hover:shadow-2xl hover:shadow-blue-900/20 transition">

                    <p class="font-display font-black text-5xl text-blue-500 mb-2">
                        2023
                    </p>
                ...
                <div class="bg-slate-900 border border-slate-800 rounded-3xl p-8 text-center hover:border-emerald-500/40 transition">

                    <p class="font-display font-black text-5xl text-emerald-500 mb-2">
                        1,200+
                    </p>
                ...
                <div class="bg-slate-900 border border-slate-800 rounded-3xl p-8 text-center hover:border-amber-500/40 transition">

                    <p class="font-display font-black text-5xl text-amber-500 mb-2">
                        350+
                    </p>
                ...
                <div class="bg-slate-900 border border-slate-800 rounded-3xl p-8 text-center hover:border-purple-500/40 transition">

                    <p class="font-display font-black text-5xl text-purple-500 mb-2">
                        4.9★
                    </p>
...
<section class="bg-black py-20 border-y border-slate-900">
    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="text-center mb-14">
            ...
            <h2 class="font-display font-black text-4xl text-white">
                Our Core Values
            </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-7">
            ...
            @foreach([
                [
                    ...
                    'desc'=>'Every device is sourced from verified distributors with genuine warranty support.',
                    'color'=>'border-blue-500/20 bg-blue-500/5'
                ],
                [
                    'icon'=>'💰',
                    'title'=>'Fair Pricing',
                    'desc'=>'Competitive pricing with transparent value and no unnecessary markups.',
                    'color'=>'border-emerald-500/20 bg-emerald-500/5'
                ],
                [
                    'icon'=>'🤝',
                    'title'=>'Customer First',
                    'desc'=>'We build long-term relationships through honest advice and support.',
                    'color'=>'border-amber-500/20 bg-amber-500/5'
                ],
            ] as $v)

            <div class="rounded-3xl border {{ $v['color'] }} p-8 backdrop-blur-xl hover:-translate-y-2 hover:border-blue-500/40 transition-all duration-500">
...
<section class="bg-slate-950 py-20">
    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="group overflow-hidden rounded-3xl bg-slate-900 border border-slate-800 shadow-xl transition-all duration-500 hover:-translate-y-2 hover:border-blue-500/40 hover:shadow-blue-900/20">
                ...
                <div class="p-8 text-center">
                    ...
                    {{-- Role --}}
                    <p class="mt-2 text-sm font-bold uppercase tracking-[0.2em] text-blue-400">
                        {{ $member->role }}
                    </p>
                    ...
                    <div class="mt-6 space-y-3 border-t border-slate-800 pt-5">
                        ...
                        <a href="tel:{{ $member->phone }}"
                           class="flex items-center justify-center gap-2 rounded-2xl bg-slate-800 px-4 py-3 text-sm font-medium text-slate-300 transition hover:bg-blue-600 hover:text-white">
                        ...
                        <a href="mailto:{{ $member->email }}"
                           class="flex items-center justify-center gap-2 rounded-2xl bg-slate-800 px-4 py-3 text-sm font-medium text-slate-300 transition hover:bg-indigo-600 hover:text-white">
...
<section class="bg-gradient-to-r from-blue-700 via-indigo-700 to-purple-700 py-16 text-center">
    ...
    <div class="max-w-3xl mx-auto px-4">
        ...
        <h2 class="font-display font-black text-4xl mb-4 text-white">
